...
import { ViewAccountPaymentInterface } from "@/interfaces/components/sales/customers/Accounts/view/ViewAccountPaymentInterface";

export function ViewAccountPayment({} : ViewAccountPaymentInterface){
